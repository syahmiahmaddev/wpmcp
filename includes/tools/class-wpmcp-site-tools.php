	...
	public function execute( array $params, int $user_id ): array {
		...
		$info = array(
			...
			'active_theme'        => array(
				...
				'version'    => is_object( $theme ) ? $theme->get( 'Version' ) : '',
				'is_block'   => function_exists( 'wp_is_block_theme' ) && wp_is_block_theme(),
				'stylesheet' => function_exists( 'get_stylesheet' ) ? get_stylesheet() : ( is_object( $theme ) ? $theme->get_stylesheet() : '' ),
				'template'   => function_exists( 'get_template' ) ? get_template() : ( is_object( $theme ) ? $theme->get_template() : '' ),
			),
